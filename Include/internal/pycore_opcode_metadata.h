...
// from:
//   Python/bytecodes.c, Python/bytecodes_overlay.c
// Do not edit!
...
const struct opcode_metadata _PyOpcode_opcode_metadata[267] = {
    ...
    [EXTENDED_OPCODE] = { true, INSTR_FMT_IB, HAS_ARG_FLAG },
...
_PyOpcode_macro_expansion[256] = {
    ...
    [EXTENDED_OPCODE] = { .nuops = 1, .uops = { { _EXTENDED_OPCODE, OPARG_SIMPLE, 0 } } },
